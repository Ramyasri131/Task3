...
function saveEmployeeDetails(event) {
    ...
    employee.forEach(r => {
        if (r.empNo == id) {
            ...
            r.role = document.getElementById("roleDropDown").value?.length ? document.getElementById("roleDropDown").value : "N/A";
...
function openhiddenOptions(x) {
    let a = x.querySelector(".options").style.visibility = "visible";
}

//to hide the options
function closehiddenOptions(x) {
    let a = x.querySelector(".options").style.visibility = "hidden";
}
...
function SubmitEmployeeDetails(event) {
    ...
    if (isInvalid == 1) {
        ...
        let formData = {
            ...
            role: document.getElementById("roleDropDown").value?.length ? document.getElementById("roleDropDown").value : "N/A",
            ...
            number: document.getElementById(formInputs[5]).value
        };
